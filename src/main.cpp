...
Motor motor_A(MA_ENB,MA_IN1,MA_IN2,MA_DIR,MA_PWM_CHANNEL_1,MA_PWM_CHANNEL_2, RESOLUTION, FREQ);
Motor motor_B(MB_ENB,MB_IN1,MB_IN2,MB_DIR,MB_PWM_CHANNEL_1,MB_PWM_CHANNEL_2, RESOLUTION, FREQ);
